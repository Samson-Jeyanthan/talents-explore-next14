...
function LinkedinIcon({ fill, width, height }: TConvertedSvgJsxProps) {
  return (
    <svg
      version="1.0"
    ...
    >
      ...
      >
        <path
          d="M599 5086 c-520 -109 -764 -698 -473 -1138 54 -81 159 -180 245 -231
...
368 -52 304 238 572 535 495z"
        />
        <path
          d="M3575 3594 c-191 -35 -386 -116 -528 -218 -43 -31 -80 -56 -83 -56
...
-215 0 -215 120 0 119 0 49 73 c157 231 373 379 642 438 117 26 359 21 472 -9z"
        />
        <path
          d="M80 1765 l0 -1745 660 0 660 0 0 1745 0 1745 -660 0 -660 0 0 -1745z
