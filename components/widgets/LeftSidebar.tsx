...
const LeftSidebar = () => {
  ...
  return (
    <Drawer>
      <aside className="sticky left-0 top-0 hidden max-h-screen min-h-screen max-w-60 flex-col items-center justify-between bg-dark-100 py-8 min-[1000px]:flex 2xl:min-w-64">
